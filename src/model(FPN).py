...
class DetectModel(nn.Module):
    ...
    def forward(self, x):      
        ...
        p4_upsampled = F.interpolate(p4, scale_factor = 2, mode = 'bilibear', align_corners = False)
        
        p3 = self.fpn_latlayer3(c3) + p4_upsampled
        p3_upsampled = F.interpolate(p3, scale_factor = 2, mode = 'bilibear', align_corners = False)
        
        p2 = self.fpn_latlayer4(c2) + p3_upsampled
        p2_upsampled = F.interpolate(p2, scale_factor = 2, mode = 'bilibear', align_corners = False)
